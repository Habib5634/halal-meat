    ...
    return (
        <>
            ...
            <div className='relative '>
                ...
                <h1 className='tracking-[123px] text-[96px] font-semibold absolute top-20 z-10 left-1/2 -translate-x-1/2 leading-[100%] text-center text-white '>HALAL</h1>
            </div>


            <div class="grid grid-cols-2 md:grid-cols-4 md:grid-rows-5 ">
                <div className='grid col-span-1 h-[983px] row-span-5'>
...
Delicious</h1>
 ...
 row-span-5'>
                    ...
                    <div class="w-full  row-span-2 grid grid-cols-2 opacity-100 bg-[#0b1920]  relative">
                        ...
                        <div className='col-span-1 bg-[#B30310] relative'>

                         <img src="/assets/square.png" className='absolute col-span-1 w-[267px] h-[256px] top-10  right-8 ' alt="" />
                         <img src="/assets/square.png" className='absolute col-span-1 w-[267px] h-[256px] bottom-10  left-8 ' alt="" />
                         <img src="/assets/square.png" className='absolute  min-w-[414px] h-[414px] bottom-0  left-1/2 -translate-x-1/2 ' alt="" />
                    ...
                    <div class="w-full row-span-3 grid grid-rows-3  opacity-100   relative">
                        <div class="w-full row-span-1  grid grid-cols-3  opacity-100   relative">
                            <div class="w-full col-span-1  opacity-100 bg-[#4e3032]   relative">
...
Weekend</h1>
                            ...
                            <div class="w-full col-span-2  opacity-100 bg-[#B30310]  relative">
                        ...
                        <div class="w-full row-span-2 grid grid-cols-2  opacity-100   relative">
