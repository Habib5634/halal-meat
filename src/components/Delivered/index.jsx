...
const Delivered = () => {
  return (
    <div className='flex justify-center items-center pr-6 ml-auto gap-6  max-w-[1260px] mt-30 '>
      <img src="/assets/elements.png" className='w-full max-w-[759px] h-full ' alt="" />
      <div className=' flex-1 w-full'>
        <h1 className='livvic-font text-[44px] font-bold leading-[47px] w-full max-w-[530px]'>Fresh Premium Halal Meats Delivered to Your Door.</h1>
